...
SWIFT_CLASS("_TtC9iyzicoSDK15IQBarButtonItem") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
SWIFT_CLASS("_TtC9iyzicoSDK28IQBarButtonItemConfiguration") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
SWIFT_CLASS("_TtC9iyzicoSDK12IQInvocation") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
SWIFT_CLASS("_TtC9iyzicoSDK17IQKeyboardManager") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
@interface IQKeyboardManager (SWIFT_EXTENSION(iyzicoSDK)) <UIGestureRecognizerDelegate>
...
SWIFT_AVAILABILITY(ios_app_extension,unavailable)
@interface IQKeyboardManager (SWIFT_EXTENSION(iyzicoSDK))
...
SWIFT_CLASS("_TtC9iyzicoSDK26IQKeyboardReturnKeyHandler") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
SWIFT_AVAILABILITY(ios_app_extension,unavailable)
@interface IQKeyboardReturnKeyHandler (SWIFT_EXTENSION(iyzicoSDK)) <UITextFieldDelegate>
...
SWIFT_AVAILABILITY(ios_app_extension,unavailable)
@interface IQKeyboardReturnKeyHandler (SWIFT_EXTENSION(iyzicoSDK)) <UITextViewDelegate>
...
SWIFT_CLASS("_TtC9iyzicoSDK18IQPreviousNextView") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
SWIFT_CLASS("_TtC9iyzicoSDK10IQTextView") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
SWIFT_CLASS("_TtC9iyzicoSDK20IQTitleBarButtonItem") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
SWIFT_CLASS("_TtC9iyzicoSDK9IQToolbar") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
SWIFT_AVAILABILITY(ios_app_extension,unavailable)
@interface UIImage (SWIFT_EXTENSION(iyzicoSDK))
...
SWIFT_AVAILABILITY(ios_app_extension,unavailable)
@interface UIScrollView (SWIFT_EXTENSION(iyzicoSDK))
...
SWIFT_AVAILABILITY(ios_app_extension,unavailable)
@interface UIView (SWIFT_EXTENSION(iyzicoSDK))
/// To set customized distance from keyboard for textField/textView. Can’t be less than zero
@property (nonatomic) CGFloat keyboardDistanceFromTextField;
...
SWIFT_AVAILABILITY(ios_app_extension,unavailable)
@interface UIViewController (SWIFT_EXTENSION(iyzicoSDK))
